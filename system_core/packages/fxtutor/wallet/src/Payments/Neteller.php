...
class Neteller extends Payments
{
    /**
     * genarate form data
     *
    ...
    public function depositRequest(Deposit $deposit)
    {
        ...
        $member->creditTransaction(TransactionModel::PENDING, 'deposit_payment_neteller', $deposit->total, $meta, $deposit);
    ...
    public function success(Request $request)
    {
        ...
        // if (!$rmember->hasRole('Administrator')) {
        ...
        $member->debitTransaction(TransactionModel::PENDING, 'approve_deposit_payment_neteller', $deposit->total, $meta, $deposit);

        // balance transaction credit
        $member->creditTransaction(TransactionModel::BALANCE, 'deposit_payment_neteller', $deposit->total, $meta, $deposit, $deposit->currency);
    ...
    public function fail(Request $request)
    {
        ...
        // pending transaction debit
        $member->debitTransaction(TransactionModel::PENDING, 'cancel_deposit_payment_neteller', $deposit->total, $meta, $deposit);
