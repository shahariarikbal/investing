...
class CreateTradingPlatformsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('broker_trading_platform', function (Blueprint $table) {
            $table->smallInteger('broker_id')->unsigned();
            $table->tinyInteger('trading_platform_id')->unsigned();

            $table->unique(['broker_id', 'trading_platform_id']);
        });
    }
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('broker_trading_platform');
    }
}
