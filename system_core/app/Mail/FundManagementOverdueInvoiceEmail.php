...
class FundManagementOverdueInvoiceEmail extends Mailable
{
    ...
    {
        return $this->subject($this->subject)->markdown('mail.fundmanagement-overdue-invoice');
    }
}
