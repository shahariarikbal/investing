...
<strong>{{ $service }} Subscription Renewal Successful</strong>

<p>Subscription of "{{ $subscription->plan->name }}" "{{ $service }}" plan renewal successful and started at {{ $subscription->start_at }} and will be valid till {{ $subscription->ends_at }}</p>
