                                        ...
                                        <div class="row">
                                            <div class="col-md-3 col-sm-5 analysis-img-section">
                                                <a href="{{ $row['permalink'] }}">
                                                    <div class="analysis-img">
                                                        <img src="{{ asset('/analyses/images/220x220-'.$row['feature_image']) }}" alt="">
                                                        <div class="date-area">
                                            ...
                                            <div class="col-md-9 col-sm-7">
                                                <div class="anylysis-info-details">
                                                        ...
                                                        <div class="rating-info">
                                                            ...
                                                            {{-- <div class="rating">
                                                                <ul>
                                                                    ...
                                                                    <li><i class="fas fa-star" aria-hidden="true"></i></li>
                                                                    <li><i class="fas fa-star" aria-hidden="true"></i></li>
                                                                    <li><span>{{ $article->average_rating }}.0 ({{ $article->review_count }} reviews)</span></li>
                                                                </ul>
                                                            </div> --}}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="body">
                                                        <p>{{ str_replace("&nbsp;", "", strip_tags($row['body'])) }}</p>
                                                    </div>
                                                    <div class="footer">
                                                        <div>
