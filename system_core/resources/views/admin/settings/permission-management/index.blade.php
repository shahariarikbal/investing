...
@section('settings-container-show', 'show')
@section('permission-management-active', 'active')
...
@section('header_styles')
    ...
    <link rel="stylesheet" href="{{ asset('/admin/vendors/Buttons/css/buttons.min.css') }}"/>
    <link rel="stylesheet" href="{{ asset('/admin/css/pages/buttons.css') }}"/>
    <style>
        .badge-half.yearly {
            background: #ffa000
        }
