                ...
                <div class="col-12 data_tables">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-t-25">
                            <a href="{{ url('/admin/manage/brokers') }}" class="btn btn-primary pull-right" title="Blog List">Back to Broker List</a>
                            <div class="">
                                ...
                                <tbody> 
                                    @foreach($brokers as $key => $broker)
                                        <tr>
                                            <td>{{ $key+1 }}</td>
                                            <td>{{ $broker->name }}</td>
                                            <td><img src="{{ asset('/broker/logo/89x36-'.$broker->logo) }}" style="height: 50px;" width="100px"></td>
                                            <td style="text-align: center;">
                                                <a href="{{ url('admin/broker/'.$broker->id.'/restore') }}" class="btn btn-raised btn-warning" id="{{$broker->id}}">Restore</a>
                                                <form method="get" action="{{ url('admin/broker/'.$broker->id.'/restore') }}" style="display: none">
                                                    @csrf
                                                </form>
                                                
                                                <a href="" onclick="
                                                    if(confirm('Are you sure, You Want to Permanent Delete?'))
                                                    {
                                                    ...
                                                    event.preventDefault();
                                                    }" class="btn  btn-danger ">Permanent Delete</i>
                                                </a>
