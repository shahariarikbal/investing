<div class="modal fade editShoutModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" style="position: relative;" id="editShoutForm">
            <div id="edit-shout-loading" style="display: none" >
            ...
            <div class="modal-content">
                ...
                <div class="card-body m-t-35">
                    <form method="post" class="form-horizontal login_validator" id="signal_form_validator">
                        <input type="hidden" id="shoutId" name="id">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xl-9">
                                ...
                                <small class="help-block error" id="edit_title_error"></small>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xl-9">
                                ...
                                <small class="help-block error" id="edit_description_error"></small>
                            </div>
                        </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary save" id="updateShout">Update Shout</button>
                        </div>
                    </form>
                </div>
            </div>
