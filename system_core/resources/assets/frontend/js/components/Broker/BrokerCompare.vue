            ...
            <div class="row">
                <div v-if="comparable" class="table-responsive table-bordered">
                                ...
                                <template v-else>
                                    ...
                                    <td v-for="broker in brokers" :key="broker.id">
                                        ...
                                        <template v-else-if="item.key === 'remove'">
                                            <button style="background: indianred;" class="btn btn-danger" @click="remove(broker['slug'])">Remove</button>
                                        </template>
                                        <template v-else>
                    ...
                    <div class="text-center mb-2">
                        ...
                        class="btn btn-info" style="padding: 0.8rem 2rem;font-size: 18px;"><i class="fas fa-arrow-left"></i> Back To Broker List</a>
                    </div>
                </div>
