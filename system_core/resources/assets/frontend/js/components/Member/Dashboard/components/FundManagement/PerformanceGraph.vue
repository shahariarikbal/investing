        ...
        <div class="row">
            <div class="col-md-12">
                <div class="title-container d-flex justify-content-between">
                    <h2 class="forex-header-second" style="font-size: 18px;"><span>performance graph</span></h2>
    ...
    export default {
        ...
        methods: {
            getPerformanceGraph (plan) {
                axios.post('/api/member/fund-management/performance-graph', { package_id: plan })
                    .then(response => {
