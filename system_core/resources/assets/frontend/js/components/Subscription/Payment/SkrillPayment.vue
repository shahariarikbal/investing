<template>
    <div class="flex flex-column mb-4 mt-4 neteller-wrapper selected-box pt-3 pl-3 pr-3 pb-1">
        <div class="mb-2">
            <span class="payment-title">Skrill payment instruction</span>
        </div>
        <div class="mb-2">
            <span> <i class="fas fa-check-circle"></i> Send your payment (${{ payable }}) st our Skrill email address through internal transfer</span>
        </div>
        <div class="skrill-mail mb-2">
            <div>
                <span><b>Our Skrill Email:</b></span>
            </div>
            <div>
        ...
        <div class="d-flex mb-2">
            <div class="form-group mb-0">
                <label for="exampleFormControlFile1" class="mb-0 font-weight-normal"> <i class="fas fa-check-circle"></i> Attach your transaction screeshot</label>
