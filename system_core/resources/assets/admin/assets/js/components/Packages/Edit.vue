<template>
    <div>
        <div class="modal fade editPackageModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" style="position: relative;" id="editPackageForm">
            <div id="edit-package-loading" style="display: none" >
                ...
                <div class="modal-content">
                    ...
                    <div class="card-body m-t-35">
                        <form name="packages" method="post" class="form-horizontal login_validator">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-9">
                                    <input type="text" name="name" placeholder="Enter Your Package Name...." class="form-control" v-model="name">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-9">
                                    <select class="form-control chzn-select" name="service" v-model="service">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-9">
                                    <select class="form-control chzn-select" name="duration" v-model="duration">
                            ...
                            <div class="form-group row" v-if="displayPriceField">
                                ...
                                <div class="col-xl-9">
                                    <input type="number" name="price" data-error-target="#price_error" v-model="price" placeholder="Enter Your Package Price...." class="form-control">
                            ...
                            <div class="form-group row">
                                <div class="col-xl-3 text-xl-right">
                                    <label for="tax" class="col-form-label">Payment</label>
                                </div>
                                <div class="col-xl-9">
                                    <div class="radio" v-if="service !== 'App\\FundManagement'">
                                        <label>
                                            <input type="radio" name="o4" v-model="recursive" :value="1">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-9">
                                    <input type="number" name="orders" data-error-target="#orders_error" v-model="orders" placeholder="Enter Your Order Number...." class="form-control">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-9">
                                    <input type="text" name="icon" data-error-target="#icon_error" v-model="icon" placeholder="Enter Your Icon Class Name...." class="form-control">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-9">
                                    <textarea name="note" data-error-target="#note_error" v-model="note" placeholder="Enter Your Icon Class Name...." class="form-control"></textarea>
                                </div>
                            </div>
...
<script>
    ...
    export default {
        ...
        mounted () {
            // fired event after clicking on edit button
            EventBus.$on('package-edit-data-fetch', (payload) => {
                this.id = payload
                axios.get('/admin/package/edit/' +payload)
                    .then(response => {
                        ...
                        this.securityDeposit = packages.settings.security_deposit
                        this.companyShare = packages.settings.company_share
                        ...
                        this.enableAffiliate = packages.settings.enable_affiliate;
                        this.affiliateLavel = packages.settings.affiliate || [{lavel: 1, percent: 0}]
                
                        this.checkedPermission = packages.settings.permissions.slice()
                        for (const key in this.newPermissions) {
                            if (this.newPermissions.hasOwnProperty(key)) {
                                const permissions = this.newPermissions[key];
                                this.newPermissions[key] = permissions.map((permission) => {
                                    if (packages.settings.permissions.indexOf(permission.name) !== -1) {
                        ...
                        if (packages.service === 'App\\FundManagement') {
                            this.displaySecurityDepositField = true
                            this.displayCompanyShareField = true
                            this.recursive = 0
                            this.displayPriceField = false
        ...
        methods: {
            ...
            adminPackageUpdate () {
                ...
                if (this.errorCount === 0) {
                    ...
                    var height = parseInt(document.getElementById('editPackageForm').offsetHeight)
                    ...
                    document.getElementById('edit-package-loading').setAttribute('style', loadingStyle)

                    axios.post('/admin/package/update/' +this.id, {
                        ...
                        .then((response) => {
                            if (response.status === 200) {
                                document.getElementById('edit-package-loading').setAttribute('style', 'display: none')
                                this.name = '',
                                this.service = '',
                                this.duration = '',
                                this.price = '',
