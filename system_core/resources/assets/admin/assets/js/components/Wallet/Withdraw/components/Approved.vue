    ...
    <div class="tab-pane fade show active mt-3" id="pending-withdraw" role="tabpanel" aria-labelledby="pending-withdraw-tab">
        ...
        <table class="table table-bordered" v-if="withdraws.length > 0">
            ...
            <tbody v-if="withdrawPages.length > 0">
                <tr v-for="(withdraw, index) in withdrawPages[currentPage - 1]" :key="withdraw.id">
                    <td>{{ index + 1 }}</td>
    ...
    export default {
        data () {
            return {
                ...
                pageCount: 1,
                currentPage: 1,
                message: 'Fetching withdraw Data From The Server. Please Wait!',
        ...
        created() {
            axios.get('/xhr/admin/wallet/withdraw/approved')
                .then(response => {
                ...
                axios.get('/xhr/admin/wallet/withdraw/transaction')
                    .then(response => {
