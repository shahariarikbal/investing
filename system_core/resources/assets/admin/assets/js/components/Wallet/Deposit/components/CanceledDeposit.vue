    ...
    export default {
        data () {
            return {
                ...
                pageCount: 1,
                currentPage: 1,
                message: 'Fetching Cancel Deposit Data From The Server. Please Wait!',
        ...
        created() {
            axios.get('/xhr/admin/wallet/deposit/canceled')
                .then(response => {
                ...
                // axios.get('/xhr/admin/wallet/member/deposit/canceled')
                //     .then(response => {
                ...
                axios.get('/xhr/admin/wallet/cancel/deposit/transaction')
                    .then(response => {
        ...
        methods: {
            ...
            approve(deposit) {
                axios.post('/xhr/admin/wallet/deposit/approve', { deposit_id: deposit.id, })
                    .then(response => {
